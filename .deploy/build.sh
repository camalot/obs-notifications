...
curl "https://gist.githubusercontent.com/camalot/6b81f824b49d646752aa99ab781053d3/raw/552a36a762c096ea0b81498f96bd48b53dba1cd0/obs-notification.env" \
	--silent --output "${WORKDIR}/.env";
